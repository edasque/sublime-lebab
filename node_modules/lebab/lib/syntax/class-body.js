...
var _methodDefinitionJs = require('./method-definition.js');

var _methodDefinitionJs2 = _interopRequireDefault(_methodDefinitionJs);
...
var ClassBody = (function (_BaseSyntax) {
  ...
  _createClass(ClassBody, [{
    ...
    value: function addMethod(method, prepend) {
      if (method instanceof _methodDefinitionJs2['default']) {
